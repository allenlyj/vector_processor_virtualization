...
// Just for testing user function
int main()
{
	int thread_id[4];
	__vp_init;
	//thread_id = process_id(16,5,&vp_amin);
	thread_id[0] = __vp_req(16,29);
	thread_id[1] = __vp_req(64,4);
	thread_id[2] = __vp_req(32,3);
	thread_id[3] = __vp_req(16,9);
#ifndef __PLATFORM_H_
	__vp_stat;
#endif
	__vp_rel(3);
